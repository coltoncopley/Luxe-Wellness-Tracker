    ...
    messages: [
      {
        ...
        content:
          ...
          "suggestion: at most ONE gentle, no-pressure invitation to ask their LUXE provider about a medical-grade alternative from the lines LUXE carries — prefer SkinMedica first, then Colorescience (only when Colorescience is the more relevant fit, e.g. mineral SPF or tinted sun protection). Name the brand and the relevant product category (e.g. 'a SkinMedica growth-factor serum'), phrased as something to ask their provider about at their next visit — never as a directive to buy or a claim it will fix their skin. " +
          "Be honest about the scanned product first: if the verdict is 'great' or 'good', say so plainly in the summary and don't undercut it. For a 'great' product, use null (or at most a light note that their provider can help round out their routine). Reserve brand-alternative suggestions mainly for 'mixed' or 'caution' products where a medical-grade upgrade genuinely helps. Use null if no alternative genuinely makes sense.",
      },
      {
        role: "user",
        content: [
