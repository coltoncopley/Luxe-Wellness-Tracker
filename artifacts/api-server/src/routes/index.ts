...
router.use(requireAuth, requireActiveSubscription, todayRouter);
router.use(requireAuth, requireActiveSubscription, routineRouter);
...
router.use(requireAuth, requireActiveSubscription, streaksRouter);
...
router.use(requireAuth, requireActiveSubscription, challengesRouter);
